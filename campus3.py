...
ciclista1 = int(input('Ingrese sus kilometros ciclista #1 '))
ciclista2 = int(input('Ingrese sus kilometros ciclista #2 '))
ciclista3 = int(input('Ingrese sus kilometros ciclista #3 '))
ciclista4 = int(input('Ingrese sus kilometros ciclista #4 '))
